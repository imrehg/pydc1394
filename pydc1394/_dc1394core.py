...
trigger_source_0_codes = invert_dict( trigger_source_0_vals )
trigger_source_t = c_int
TRIGGER_SOURCE_MIN = min( trigger_source_0_vals.keys())
TRIGGER_SOURCE_MAX = max( trigger_source_0_vals.keys())
