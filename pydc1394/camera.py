...
class Camera(object):
    ...
    def reset_bus( self ):
        """This function resets the bus the camera is attached to. Note
        that this means that all cameras have to reenumerate and will
        drop frames. So only use this if you know what you are doing.
        """
        if self.running:
            self.stop()
